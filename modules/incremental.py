...
def main():
    files = ['Data-pipeline-Individual/Market 1 Orders.csv',
             'Data-pipeline-Individual/Market 2 Orders.csv',
             'Data-pipeline-Individual/Market 2 Deliveries.csv',
             'Data-pipeline-Individual/Market 1 Deliveries.csv']
    for file_path in files:
        last_processed_user = None
        last_processed_user = incremental_update(
            file_path, last_processed_user)
        output_path = os.path.join('Data-Pipeline-Individual', os.path.basename(
